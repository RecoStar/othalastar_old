...
$a_lang_array = (array(
  ...
  'adm_ov_altpm' => '[PM]',
  'adm_ov_hint' => '<ul><li>The table of users online can be sorted by columns. "ID", "Player Name", "Alliance "," Points "and" Activity. "To sort by a specific column, click on its title.</li></ul>',
  ...
  'adm_user_online' => 'Online with %s by %s',

  'adm_ban_unban' => 'Ban/Unban',
  'adm_metametter_payment' => 'MM & Payments',
