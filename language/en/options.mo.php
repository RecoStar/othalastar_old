...
$a_lang_array = array(
  ...
  'PLAYER_OPTION_UNIVERSE_OLD' => 'Use the old view of the Universe"',
  'PLAYER_OPTION_UNIVERSE_DISABLE_COLONIZE' => 'Disable the colonization button',
  ...
  'opt_sound_enabled' => 'Enable sounds in the game',

  'opt_account_name' => 'Your login <br /> This name must be entered when entering the game',
  'opt_game_user_name' => 'Name in the game <br /> By this name you will be visible to other players of the server',
