...
// top bar
  ...
  'flt_error_duration_wrong' => 'Unable to send fleet - no delay intervals available. Learn more Astrocartography levels',
  'flt_stay_duration' => 'Time',

  'flt_mission_expedition' => array(
    'msg_sender' => 'Expedition report',
    'msg_title' => 'Expedition report',
    'found_dark_matter' => 'Received %1$d unit of Dark Matter!',
    'found_resources' => "Resources found:\r\n",
    'found_fleet' => "Ships found:\r\n",
    'lost_fleet' => "The following ships are lost:\r\n",
    'outcomes' => array(
      FLT_EXPEDITION_OUTCOME_NONE => array(
        'messages' => array(
          'Your researchers found nothing',
        ),
      ),

      FLT_EXPEDITION_OUTCOME_LOST_FLEET => array(
        'messages' => array(
          'The fleet fell into a black hole and partially lost!',
        ),
      ),

      FLT_EXPEDITION_OUTCOME_LOST_FLEET_ALL => array(
        'messages' => array(
          'If you only saw it! It is so beautiful ... It calls to itself ... (connection with the fleet is lost)',
          // 'Fleet report% 1 $ s. We have completed the study of the sector. The team is unhappy. Hey, what are you doing on the bridge ?! (connection with the fleet is lost)',
          'Fleet report% 1 $ s. All is quiet (interference) (connection with the fleet is lost)',
          'AAAAAAH! WHAT IS IT?! WHERE IT TAKES (connection with the fleet is lost)',
          'An unknown object was detected. It does not respond to requests for standard protocols. We send probe for research (connection with the fleet is lost)',
        ),
      ),

      FLT_EXPEDITION_OUTCOME_FOUND_FLEET => array(
        'no_result' => 'Unfortunately, the total power of all the fleet computers was not enough even to control the smallest ship. Try sending more ships and / or larger ships.',
        'messages' => array(
          0 => array(
            'You have found a completely new fleet!',
          ),
          1 => array(
            'You found a fleet!',
          ),
          2 => array(
            'You found a used fleet!',
          ),
        ),
      ),

      FLT_EXPEDITION_OUTCOME_FOUND_RESOURCES => array(
        'no_result' => 'The holds of your fleet were unable to accommodate at least one container with resources. Try to send a fleet with a large number of transport workers.',
        'messages' => array(
          0 => array(
            'You have found a pirate treasure with resources. How many ships were destroyed to collect so much good?',
          ),
          1 => array(
            'You found an abandoned asteroid base. I wonder what happened to its inhabitants? Examining the ruins, you found several surviving vaults.',
          ),
          2 => array(
            'You stumbled upon a destroyed transport convoy. Searching the holds of the wrecked ships, you found some resources.',
          ),
        ),
      ),

      FLT_EXPEDITION_OUTCOME_FOUND_DM => array(
        'no_result' => 'Unfortunately, all the fleet drives were not enough to assemble a single DM. Try to send a larger fleet',
        'messages' => 'Your fleet witnessed the birth of SuperNova.',
        /*
        'messages' => array(
  ...
  'sys_result' => array(
    'error_dark_matter_not_enough' => 'Not enough Dark Matter to complete the operation',
    'error_dark_matter_change' => 'Error changing the amount of dark matter! Repeat the operation again. If the error persists, inform the Server Administration.',
  ),
...
//  'sys_dark_matter_obtain_text_convert' => '<br />Besides, you can convert Metamatter to Dark Matter. <a href="metamatter.php" class="link">More about Metamatter</a>',
  ...
  'ube_report_capture_result' => array(
    UBE_CAPTURE_DISABLED => 'Planet Capture Disabled',
    UBE_CAPTURE_NON_PLANET => 'You can only capture planets',
    UBE_CAPTURE_NOT_A_WIN_IN_1_ROUND => 'To capture the planet, the battle must end in a victory in the first round.',
    UBE_CAPTURE_TOO_MUCH_FLEETS => 'When capturing the planet in battle, only the fleet invader and the planetary fleet should participate.',
    UBE_CAPTURE_NO_ATTACKER_USER_ID => 'INTERNAL ERROR - No attacker ID! Notify the developer!',
    UBE_CAPTURE_NO_DEFENDER_USER_ID => 'INTERNAL ERROR - No defender ID! Notify the developer!',
    UBE_CAPTURE_CAPITAL => 'You can not seize the capital',
    UBE_CAPTURE_TOO_LOW_POINTS => 'It is possible to capture planets only from players whose total number of points is at least 2 times greater than the number of points from an attacker.',
    UBE_CAPTURE_NOT_ENOUGH_SLOTS => 'There are no more planet capture slots',
    UBE_CAPTURE_SUCCESSFUL => 'The planet is captured by the attacking player.',
  ),
  ...
  'sys_auth_provider_list' => array(
    ACCOUNT_PROVIDER_NONE => 'USERS table',
    ACCOUNT_PROVIDER_LOCAL => 'ACCOUNT table',
    ACCOUNT_PROVIDER_CENTRAL => 'ACCOUNT central table',
  ),

  'sys_login_messages' => array(
    LOGIN_UNDEFINED => 'Login process does not started',
    LOGIN_SUCCESS => 'Login succesfull',
    LOGIN_ERROR_USERNAME_EMPTY => 'Player name cannot be empty',
    LOGIN_ERROR_USERNAME_RESTRICTED_CHARACTERS => 'Characters are not allowed in player name and login ',
    LOGIN_ERROR_USERNAME => 'There is no player with such name',
    LOGIN_ERROR_USERNAME_ALLY_OR_BOT => 'This name belongs to the Alliance or bot. You cannot login under it ... at least for now',
    LOGIN_ERROR_PASSWORD_EMPTY => 'Password can not be empty',
    LOGIN_ERROR_PASSWORD_TRIMMED => 'The password cannot begin or end with a space, tab or line feed.',
    LOGIN_ERROR_PASSWORD => 'Wrong password',
    //    LOGIN_ERROR_COOKIE => '',

    REGISTER_SUCCESS => 'Registration succesfully complete',
    REGISTER_ERROR_BLITZ_MODE => 'Registration of new players in the blitz server mode is disabled',
    ...
    REGISTER_ERROR_USERNAME_SHORT => 'Too short name. The name must consist of at least ' . LOGIN_LENGTH_MIN. ' символов',
    REGISTER_ERROR_PASSWORD_DIFFERENT => 'Password does not match confirmation password',
    REGISTER_ERROR_EMAIL_EMPTY => 'E-mail cannot be empty',
    REGISTER_ERROR_EMAIL_WRONG => 'The e-mail entered is not an email address.',
    ...
    PASSWORD_RESTORE_ERROR_CODE_OK_BUT_NO_ACCOUNT_FOR_EMAIL => 'The recovery code is correct, but no account with such email has been found. It may have been deleted or an internal error occurred. Contact the Server Administration.',
    ...
    LOGIN_ERROR_SYSTEM_ACCOUNT_TRANSLATION => 'SYSTEM ERROR - FAILURE IN PROVIDERS TRANSLATION TABLE! Notify server administration!',
  ...
  'imp_stat_header' => 'Change schedule',
  'imp_stat_types' => array(
    'TOTAL_RANK' => 'Place in the overall statistics',
    'TOTAL_POINTS' => 'Total points',
    // 'TOTAL_COUNT' => 'Total resources',
    'TECH_RANK' => 'Place in research statistics',
    'TECH_POINTS' => 'Points for Research',
    // 'TECH_COUNT' => 'Number of levels',
    'BUILD_RANK' => 'Place in construction statistics',
    'BUILD_POINTS' => 'Number of points for Buildings',
    // 'BUILD_COUNT' => '',
    'DEFS_RANK' => 'Place in the statistics on Defense',
    'DEFS_POINTS' => 'Points for Defense',
    //'DEFS_COUNT' => '',
    'FLEET_RANK' => 'Place in the statistics on ships',
    'FLEET_POINTS' => 'Points for Ships',
    //'FLEET_COUNT' => '',
    'RES_RANK' => 'Place in the statistics on free resources',
    'RES_POINTS' => 'Points for free resources',
    //'RES_COUNT' => '',
  ),
  ...
  'sys_blitz_page_disabled' => 'In the blitz server mode, this page is not available',
  'sys_blitz_registration_disabled' => 'Registration for the game in the Blitz server is disabled',
  'sys_blitz_registration_no_users' => 'No registered players',
  'sys_blitz_registration_player_register' => 'Register for the game',
  'sys_blitz_registration_player_register_un' => 'Revoke registration',
  'sys_blitz_registration_closed' => 'Registration is closed for now. Try again later',
  'sys_blitz_registration_player_generate' => 'Generate logins and passwords',
  'sys_blitz_registration_player_import_generated' => 'Import Generated String',
  'sys_blitz_registration_player_name' => 'Your login for the Blitz server:',
  'sys_blitz_registration_player_password' => 'Your password for the Blitz server:',
  'sys_blitz_registration_server_link' => 'Link to the Blitz server',
  'sys_blitz_registration_player_blitz_name' => 'Name on the Blitz server',
  'sys_blitz_registration_price' => 'Application fee',
  'sys_blitz_registration_mode_list' => array(
    BLITZ_REGISTER_DISABLED => 'Registration is disabled',
    BLITZ_REGISTER_OPEN => 'Registration is open',
    BLITZ_REGISTER_CLOSED => 'Registration is closed',
    BLITZ_REGISTER_SHOW_LOGIN => 'Open logins and passwords',
    BLITZ_REGISTER_DISCLOSURE_NAMES => 'Summarizing',
  ),

  'survey' => 'Interview',
  'survey_questions' => 'Options for selection',
  'survey_questions_hint' => '1 option per line',
  'survey_questions_hint_edit' => 'Edited poll will reset its results',
  'survey_until' => 'The duration of the survey (1 day by default)',

  'survey_votes_total_none' => 'No one has voted yet ... Vote first!',
  'survey_votes_total_voted' => 'Already voted:',
  'survey_votes_total_voted_join' => 'Vote or lose!',
  'survey_votes_total_voted_has_answer' => 'You have already voted. Together with you voted',

  'survey_lasts_until' => 'The poll will last until',

  'survey_select_one' => 'Select one answer and click',
  'survey_confirm' => 'To vote!',
  'survey_result_sent' => 'Your vote has been counted. Refresh the page or use the link <a class="link" href="announce.php">Новости</a> to see current survey results.',
  ...
  'sys_blitz_reward_log_message' => 'Blitz server %1$d prize place blitz name "%2$s"',
  'sys_blitz_registration_view_stat' => 'View Blitz server statistics',

  'sys_login_register_message_title' => "Your name and password to enter the game",
  'sys_login_register_message_body' => "Your login name (login)\r\n%1\$s\r\n\r\nYour password to enter the game\r\n%2\$s\r\n\r\nWrite down or remember this data!",

  'auth_provider_list' => array(
    ACCOUNT_PROVIDER_NONE => 'Table users',
    ACCOUNT_PROVIDER_LOCAL => 'Table account',
    ACCOUNT_PROVIDER_CENTRAL => 'Central storage',
  ),

  'bld_autoconvert' => 'Automatic conversion when creating a unit {%1$d} "%4$s" in quantity %2$d on the planet %3$s',

  'news_show_rest' => 'Show news text',
  ...
  'sys_confirm_action_title' => 'Confirm your action',
  'sys_confirm_action' => 'Do you really want to do it?',
