...
class classConfig extends classPersistent {
  protected $defaults = array(
    ...
    'rpg_bonus_minimum'       => 100, // Minimum DM ammount for starting paying bonuses to affiliate

    // Black Market - General
    'rpg_cost_banker'         => 10, // Banker can hold some resources
    'rpg_cost_exchange'       => 10, // Exchange allows resource trade between players
    'rpg_cost_info'           => 100, // Infotrader sells valuable information about users, alliances and universe
    'rpg_cost_pawnshop'       => 100, // You can get loan in pawnshop
    'rpg_cost_scraper'        => 10, // Scrapper buys ship for fraction of cost
    'rpg_cost_stockman'       => 10, // Stockman resells ship that was scrapped
